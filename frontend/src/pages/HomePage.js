...
const whyUs = [
  {
    ...
    desc: "Fast, iterative delivery that adapts to your evolving needs.",
  },
  {
    icon: Shield,
    title: "Proven Expertise",
    desc: "Certified SAP consultants with deep industry experience.",
  },
  {
    icon: TrendingUp,
    title: "Cost Effective",
    desc: "Best practice-oriented solutions that maximize your ROI.",
  },
  {
    icon: CheckCircle2,
    title: "End-to-End Support",
    desc: "From implementation to training, we cover the entire spectrum.",
  },
];
    ...
    <div data-testid="home-page">
      ...
      >
        ...
        <motion.div
          ...
          className="relative max-w-7xl px-6 md:px-12 lg:px-24 pt-32 pb-20 ml-0 md:ml-12 lg:ml-16"
        >
          <motion.div
          ...
          >
            <span
              className="uppercase tracking-[0.3em] text-xs font-bold text-[#1ab69e] font-body"
              data-testid="hero-overline"
            >
              EYESAP TECHNOLOGY
            </span>
            <h1
              className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl text-white tracking-[0.02em] mt-4 leading-[1.1]"
            ...
            <p
              className="text-slate-300 text-base sm:text-lg font-body mt-6 leading-relaxed max-w-2xl tracking-wide"
              data-testid="hero-subtitle"
            >
              Full-service IT consulting specializing in SAP Implementation,
              Staffing, and Professional Training for enterprises of all sizes.
            </p>
            <div className="flex flex-wrap gap-4 mt-8">
              <Link to="/contact">
                <Button
                  className="bg-[#1ab69e] hover:bg-[#149380] text-white font-body font-semibold px-8 py-6 rounded-full text-base"
              ...
              <Link to="/about">
                <Button
                  variant="outline"
                  className="border-2 border-white/30 text-white hover:bg-white/10 font-body font-semibold px-8 py-6 rounded-full text-base"
          ...
          >
            {stats.map((s, i) => (
              <motion.div key={i} {...fadeUp} className="text-center">
                <span
                  className="font-heading font-black text-3xl sm:text-4xl text-[#1ab69e]"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <motion.div {...fadeUp} className="mb-16">
            <span className="uppercase tracking-[0.2em] text-xs font-bold text-[#1ab69e] font-body">
              Our Services
            </span>
            ...
            <p className="text-[#64748B] font-body mt-4 max-w-lg">
              We deliver cost-effective IT solutions that drive business growth
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, i) => (
              ...
              >
                ...
                >
                  <div
                    className={`bg-white rounded-2xl p-8 lg:p-10 border border-slate-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 h-full`}
                  >
                    <div
                    ...
                    <h3 className="font-heading font-semibold text-xl text-[#0F172A] tracking-tight mb-3">
                      {service.title}
                    </h3>
                    <p className="text-[#64748B] font-body text-sm leading-relaxed mb-6">
                      {service.desc}
                    </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeUp}>
              ...
              <p className="text-[#64748B] font-body mt-4 leading-relaxed">
                With a team of certified SAP consultants and deep industry
                ...
                {whyUs.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[#64748B] font-body text-xs mt-1 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </motion.div>
            ...
            <motion.div {...fadeUp} transition={{ duration: 0.8, delay: 0.2 }}>
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-[#1ab69e] rounded-2xl p-6 text-white shadow-xl">
                  ...
                  <p className="text-sm font-body mt-1 text-white/80">
                    Years of Excellence
                  </p>
                </div>
              </div>
      ...
      {/* CTA */}
      <section
        className="py-24 lg:py-32 bg-[#0F172A]"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-slate-400 font-body mt-4 max-w-lg mx-auto">
              Let's discuss how EYESAP Technology can help you achieve your SAP
              goals.
            </p>
            <Link to="/contact">
              <Button
                className="bg-[#1ab69e] hover:bg-[#149380] text-white font-body font-semibold px-10 py-6 rounded-full text-base mt-8"
